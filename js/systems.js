...
/* ============================================================
   ...
   ============================================================ */
/* Цвет и знак — не украшение, а подсказка. Все три бонуса были одинаковыми
   золотыми шариками с «$», «!» и «~», и человек ловил их не понимая, что
   поймал: деньги, тап или доход. Теперь цвет тот же, что и везде в игре —
   жёлтый деньги, цвет пути руки, зелёный доход. */
const BONUS_TYPES = [
